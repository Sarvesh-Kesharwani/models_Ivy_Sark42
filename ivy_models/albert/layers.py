...
class AlbertSelfAttention(ivy.Module):
    def __init__(
        self,
        hidden_size,
        num_attention_heads,
        ...
        self.max_position_embeddings = max_position_embeddings
        super(AlbertSelfAttention, self).__init__(v=v)
...
class AlbertAttention(ivy.Module):
    def __init__(
        self,
        hidden_size,
        num_attention_heads,
        ...
        self.max_position_embeddings = max_position_embeddings
        self.num_attention_heads = num_attention_heads
        super(AlbertAttention, self).__init__(v=v)

    def _build(self, *args, **kwargs):
        self.self = AlbertSelfAttention(
            self.hidden_size,
            self.num_attention_heads,
...
class AlbertFeedForward(ivy.Module):
    def __init__(
        self,
        hidden_size,
        intermediate_size,
        ...
        self.layer_norm_eps = layer_norm_eps
        super(AlbertFeedForward, self).__init__(v=v)
