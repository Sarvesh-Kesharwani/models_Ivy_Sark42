...
# setting paths
file_count_path = "/workspaces/models_Ivy_Sark42/log_sys/file_count.txt"
...
# setting more paths
file_backup_path = (
    f"/workspaces/models_Ivy_Sark42/log_sys/inputs/input_{file_count}.json"
)
file_latest_path = f"/workspaces/models_Ivy_Sark42/log_sys/inputs/input.json"
